...
const mockEvents = {
    events: [
        { title: 'Docker Event', id: 1, description: 'Creating Images', location: 'Joes pizza', likes: 0 },
        { title: 'Kubernetes Event', id: 2, description: 'Kubernetes Cluster creation', location: 'Johns pizza', likes: 0 }
    ]
};
